...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services', 'starter.directives', 'ngCordova', 'credit-cards'])
...
.config(function($stateProvider, $compileProvider, $urlRouterProvider) {
  ...
  .state('forgot.number', {
    url: '/number',
    templateUrl: 'templates/forgot-number.html',
    controller: 'ForgotNumberCtrl'
  })
  .state('forgot.code', {
    url: '/code/:token',
    templateUrl: 'templates/forgot-code.html',
    controller: 'ForgotTestCodeCtrl'
  })
  .state('forgot.newpass', {
    url: '/newpass/:token',
    templateUrl: 'templates/forgot-newpass.html',
    controller: 'ForgotNewpassCtrl'
  })
  .state('main', {
    url: '/',
    template: '<ion-nav-view/>',
